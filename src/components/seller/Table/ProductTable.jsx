...
import {formatCurrency, formatDate, formatSmallDate} from "../../../utils/format";
        ...
        <div className="rounded-[6px] bg-white p-5 shadow-md">
            <table className="w-full">
                ...
                <tr className="flex justify-start gap-5 items-center text-md font-bold text-black-1 capitalize pb-3">
                    ...
                    <th className="w-[150px] text-right">Thao tác</th>
                </tr>
                </thead>
                <tbody>
                {products.map((product, index) => {
                    return (
                        <tr key={index}
                            className="flex justify-start gap-5 items-center text-black-1 capitalize border-t py-4 border-dashed border-[#efefef]">
                            ...
                            <th className="w-[120px] text-right">
                                <p className="text-tiny font-medium">
                                    {formatSmallDate(product.updatedAt)}
                                </p>
                            </th>
