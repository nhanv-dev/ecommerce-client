            ...
            <div className="mt-3">
                <div className="flex items-center justify-start gap-3 mb-6">
                    ...
                    <div className="flex-1">
                        <p className="font-medium text-md line-clamp-1 mb-0.5">
                            {user.info?.fullName}
                        </p>
                        <Link to="/nguoi-dung/thong-tin"
                              className="flex items-center justify-start gap-1 text-sm text-[#888] hover:text-primary-hover transition-all">
                ...
                <div className="mb-2">
                    <Link to="/nguoi-dung/thong-tin"
                          className="block font-bold text-base mb-3 hover:text-primary-hover">
                        Quản lý tài khoản
                    </Link>
                    <div className="flex flex-col gap-4 ml-5 mb-5">
                        <Link to="/nguoi-dung/thong-tin"
                              className="flex items-center justify-start gap-2 font-medium text-md text-black-1 transition-all hover:text-primary-hover">
                ...
                <div className="mb-2">
                    <Link to="/nguoi-dung/don-hang" className="block font-bold text-base mb-3 hover:text-primary-hover">
                        Đơn hàng của tôi
                    </Link>
                    <div className="flex flex-col gap-4 ml-5 mb-5">
                ...
                <div className="mb-2">
                    <Link to="/nguoi-dung/cau-hoi" className="block font-bold text-base mb-3 hover:text-primary-hover">
                        Câu hỏi của tôi
                    </Link>
                </div>
                <div className="mb-2">
                    <Link to="/kenh-ban-hang" className="block font-bold text-base mb-3 hover:text-primary-hover">
