...
function Feedback({showFeedback, setShowFeedback, item}) {
    ...
    return (
        <div onClick={() => setShowFeedback(true)}
             className={`${showFeedback ? 'visible opacity-100' : 'invisible opacity-0'} fixed top-0 left-0 right-0 bottom-0 z-[40] transition-all after:absolute after:bg-[#000] after:opacity-20 after:top-0 after:left-0 after:right-0 after:bottom-0`}>
            <div
