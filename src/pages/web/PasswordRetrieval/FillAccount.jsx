...
function FillAccount({num, setNumber}) {

    return (
            <div
                className={`${num === "1" ? '': 'hidden'} min-h-[100vh] bg-cover bg-[#f4f4f4] bg-center relative after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:bg-[#000] after:z-10 after:opacity-40`}
