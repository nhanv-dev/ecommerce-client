                        ...
                        <div className="flex basis-1/2 justify-center">
                            <form className="px-8 pt-6 pb-2 mb-4 h-50 w-full">
                                <div className="mb-4 flex items-center ">
                                    <label
                                        className="mt-1 text-[12px] basis-1/2 w-[60%] text-right font-medium mb-2 mr-2"
                                        htmlFor="username">
                                        HỌ TÊN NGƯỜI NHẬN
                                    </label>
                                    <input
                                ...
                                <div className="mb-4 flex items-center ">
                                    <label className="mt-1 text-[12px] basis-1/2 text-right font-medium mb-2 mr-2"
                                           htmlFor="phone">
                                        SỐ ĐIỆN THOẠI
                                    </label>
                                    <input
                                ...
                                <div className="text-left flex">
                                    <label className="text-[12px] basis-1/2 mt-2 text-right font-medium mb-2 mr-1.5"
                                           htmlFor="email">
