                    ...
                    <div className="bg-white shadow-sm rounded-md p-8">
                        <form className="mx-auto w-[800px]">
                            <div className="mb-4 flex items-center ">
                                <label className="text-[12px] text-right font-medium mb-2 mr-2"
                                       htmlFor="username">
                                    HỌ TÊN NGƯỜI NHẬN
                                </label>
                                <input
                            ...
                            <div className="mb-4 flex items-center ">
                                <label className="text-[12px] basis-1/2 text-right font-medium mb-2 mr-2"
                                       htmlFor="phone">
                                    SỐ ĐIỆN THOẠI
                                </label>
                                <input
                            ...
                            <div className="form-group text-left flex items-center w-full mb-4 relative ">
                                <label className="text-[12px] basis-1/2 text-right font-medium">
                                    CHỌN TỈNH THÀNH
                                </label>
                                <div className="shadow w-full">
                                    <div className="flex cursor-pointer">
                                        <input
                                            ...
                                            type="text" value={selectCity} placeholder="Chọn Tỉnh thành"
                                            onClick={() => {
                                        ...
                                        <icon.UilAngleDown
                                            className={`inline absolute top-1.5 right-0 transition duration-500 ${openCity && 'rotate-180'}`}
                                            onClick={() => {
                                                setOpenCity(!openCity);
                                                setOpenDis(false);
                                                setOpenWard(false)
                                ...
                                <div className="shadow w-full">
                                    <div className="flex  relative">
                                        <input
                                            ...
                                            id="phone" type="text" value={selectDis} placeholder="Chọn Quận/Huyện"
                                            onClick={() => {
                                                setOpenCity(false);
                                                setOpenDis(!openDis);
                                                setOpenWard(false)
                                        ...
                                        <icon.UilAngleDown
                                            className={`inline absolute top-1.5 right-0 transition duration-500 ${openDis && 'rotate-180'}`}
                                            onClick={() => {
                                                setOpenCity(false);
                                                setOpenDis(!openDis);
                                                setOpenWard(false)
                            ...
                            <div className="form-group text-left flex w-full items-center mb-4 relative ">
                                <label className="text-[12px] basis-1/2 text-right font-medium mt-1">
                                    CHỌN PHƯỜNG/XÃ
                                </label>
                                <div className="shadow w-full">
                                    <div className="flex  relative">
                                        <input
                                            className="shadow cursor-pointer w-full inline text-[#6B6A6A] text-md appearance-none border border-border rounded py-2 px-3 text-gray-700 leading-tight bg-[#FAFAFA] focus:outline-[#FAFAFA]  focus:shadow-outline"
                                            id="phone" type="text" value={selectWard} placeholder="Chọn Phường/Xã"
                                            onClick={() => {
                                                setOpenWard(false);
                                                setOpenDis(false);
                                        ...
                                        <icon.UilAngleDown
                                            className={`inline absolute top-1.5 right-0  transition duration-500 ${openWard && 'rotate-180'}`}
                                            onClick={() => {
                                                setOpenWard(false);
                                                setOpenDis(false);
                                                setOpenWard(!openWard)
                            ...
                            <div className="text-left flex">
                                <label className="text-[12px] basis-1/2 mt-2 text-right font-medium"
                                       htmlFor="email">
                                ...
                                <div className="w-full">
                                    <input
                                        ...
                                        id="email" type="text"
                                        placeholder="Nhập để nhận thông tin đơn hàng qua email"/>
                                    <div className="py-3 flex items-center">
                                        <input className="mt-0.5 mr-2 w-[18px] h-[18px] accent-primary"
                                    ...
                                    <div>
                                        <Link className="flex gap-2" to={`/thay-doi-dia-chi/`}>
                                            <button
                                                className="px-8 py-2 bg-[#888A8E] basis-1/2 font-medium text-white rounded-md transition duration-400 hover:bg-[#999999] active:bg-[#888A8E]">Hủy
                                            </button>
                                            <button
                                                className="px-8 py-2 bg-primary basis-1/2 font-medium text-white rounded-md transition duration-400 hover:bg-primary-hover active:bg-primary">Tiếp
                                                tục
                                            </button>
                                        </Link>
                                    </div>
